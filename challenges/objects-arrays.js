...
const vElo = makeDinosaurObject('velociraptor','carnivorous','15kg','1,8m','Late Cretaceous')
...
const contactInfo = graduates.map((first_name,email) => {
...
*/
const displayNames = [];
zooAnimals.forEach((elements) => {displayNames.push(elements.animal_name + ', ' + elements.scientific_name)})
